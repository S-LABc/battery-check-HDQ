...
//KUTUPHANE GEREKLI AYRICA PORT MANUEL GIR
HDQBATT HDQ(5);
...
void readBatteryData() {
  ...
  // Модель контроллера
  Serial.print("AYGIT TIPI: ");
  Serial.println(HDQ.getDeviceType(), HEX);
  
  // Версия прошивки
  Serial.print("BELLENIM VERSIYONU: ");
  Serial.println(HDQ.getFirmwareVersion());

  // Версия оборудования
  Serial.print("DONANIM VERSIYONU: ");
